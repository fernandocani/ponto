...
@objc public protocol SMDatePickerDelegate {
    ...
    @objc optional func datePickerDidClear(_ picker: SMDatePicker, dateNil date: Date)
...
@objc public class SMDatePicker: UIView {
    ...
    */
    public func pressedClear(_ sender: AnyObject) {
        hidePickerAnimation(true)
        let formatter = DateFormatter()
        formatter.dateFormat = ""
        delegate?.datePicker?(self, didPickDate: formatter.date(from: "")!)
    }
}
